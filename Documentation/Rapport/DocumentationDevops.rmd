...
Pour assurer la fiabilité de notre application, nous avons mis en place des tests unitaires avec JUnit 5 et Mockito.

Nous avons principalement testé les services, car ils contiennent la logique métier (recherche de bibliothèques, gestion des sessions, notifications, feed, etc.).
Nous avons également testé certaines entités, des DTO ainsi qu’un composant lié à la sécurité.

Grâce à Mockito, les repositories sont simulés, ce qui nous permet de tester la logique indépendamment de la base de données.

Ces tests nous permettent de vérifier le bon fonctionnement des fonctionnalités, de gérer les cas d’erreur et d’éviter les régressions lorsque le projet évolue.
...
```{r, echo=FALSE, out.width="100%", fig.align="center", fig.pos="H"}
knitr::include_graphics("recherchebiblio.png")
```

```{r, echo=FALSE, out.width="100%", fig.align="center", fig.pos="H"}
knitr::include_graphics("resultatRechercheBib.png")
```
...
### Petite Feature : Option d'ajouter des commentaire


## Feature 4 : Création d'une session 
...
```{r, echo=FALSE, out.width="100%", fig.align="center", fig.pos="H"}
knitr::include_graphics("creationSession.png")
```
...
### Petite Feature : Consulter l'historique des sessions
...
```{r, echo=FALSE, out.width="100%", fig.align="center", fig.pos="H"}
knitr::include_graphics("favori.png")
```

## Feature 6 : Recevoir des notifications
